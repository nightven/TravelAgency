...
<section>
    <div class="container-fluid">
        <span style="text-align: center;"><h1><fmt:message key="label.admin.create-tour" bundle="${ rb }" /></h1></span>
        <div class="before-grid">
            <hr>
        </div>
        <form role="form" id="create-vacation-form" method="post" action="travel" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="form-group col-sm-6 col-sm-offset-3">
                    ...
                    <textarea class="form-control" rows="5" id="services" name="services" required></textarea>
                </div>
            </div>
            <div class="row">
                <div class="form-group col-sm-6 col-sm-offset-3">
...
<script>
    ...
    $('#reset-img-preview').click(function() {
        $('#img').val('');
        $('#img-preview').attr('src', 'http://placehold.it/480x360');
    });
